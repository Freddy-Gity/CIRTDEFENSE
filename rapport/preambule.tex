...
%\usepackage{enumerate}  % neutralise : enumitem (plus haut) le supplante
%                        % et le chargement tardif casserait \begin{enumerate}[...]					%For enumeration counter
...
%
\AtBeginDocument{\renewcommand{\bibname}{R\'ef\'erences bibliographiques}}
\AtBeginDocument{\renewcommand{\refname}{R\'ef\'erences bibliographiques}}
...
%% Paquets de mise en page charges apres le glossaire dans le modele
\usepackage{chngcntr}
